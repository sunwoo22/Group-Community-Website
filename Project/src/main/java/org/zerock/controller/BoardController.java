...
//		model.addAttribute("pageMaker",new PageDTO(cri,123));
	...
	public String register(BoardVO board, RedirectAttributes rttr, HttpServletResponse response)
		...
		out.println("<script>alert('등록되었습니다.'); location.href='http://localhost:8080/board/list';</script>");
	...
	@PostMapping("/modify")
	public String modify(BoardVO board,@ModelAttribute("cri") Criteria cri, RedirectAttributes rttr, HttpServletResponse response) 
			throws ServletException, IOException {
		...
		out.println("<script>alert('수정되었습니다.'); location.href='http://localhost:8080/board/list';</script>");
	...
	@PostMapping("/remove")
	public String remove(Long b_no,@ModelAttribute("cri") Criteria cri,RedirectAttributes rttr, HttpServletResponse response) 
			throws ServletException, IOException {
		...
		out.println("<script>alert('삭제되었습니다.'); location.href='http://localhost:8080/board/list';</script>");
