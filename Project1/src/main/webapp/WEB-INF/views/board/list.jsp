	...
	<div class="row">
		...
		<div class="col-twelve">
			...
			<table width="100%" style="text-align: center;"
				...
				<thead>
					<tr>
						<th style="width: 240px; text-align: center;">no</th>
				...
				<tbody>
					<c:forEach items="${list}" var="board">
						<tr class="odd gradeX">
							<td style="text-align: center; font-size:14px;"><c:out value="${board.b_no}" /></td>
							<td><a class="move" href='<c:out value="${board.b_no}" />'>
									<c:out value="${board.b_title}" />
							</a></td>
							<td style="text-align: center; font-size:14px;"><fmt:formatDate value="${board.b_date}"
			...
			<c:choose>
						<c:when test="${id != null}">
							<button id='regBtn' class="submit button-primary full-width-on-mobile">New Post</button>
						</c:when>
						<c:otherwise>
							<button class="submit button-primary full-width-on-mobile" onclick="needLogin()">New Post</button>
