		...
		<div class="col-twelve">
			...
			<section>
				...
				<div class="content-media">
					...
					<label>content</label>
					<textarea class="full-width" name="b_content" style="margin: 0;" onkeyup="chkByte(this, 2000)">
					...
					<button type="submit" data-oper="modify" class="submit button-primary full-width-on-mobile">Submit</button>
