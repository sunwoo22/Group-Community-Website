...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
				...
				<!-- comment.jsp start-->
					...
					<div class="form-field" style="margin-bottom: 30px;">
							...
							<button type="submit" class="submit button-primary full-width-on-mobile"
								style="height: 56px;">submit</button>
						...
						<div class="form-field" style="margin-bottom: 30px;">
							...
							<button onclick="needLogin()" class="submit button-primary full-width-on-mobile"
								style="height: 56px;">submit</button>
