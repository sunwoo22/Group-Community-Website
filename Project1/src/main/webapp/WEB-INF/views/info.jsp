   ...
   <section id="content-wrap" class="blog-single">
   			...
   			<article class="format-standard">  
   				...
   				<div class="content-media">
					...
					<c:when test="${group.g_img_src != null}">
						 <img src="${group.g_img_src}" style="width:100%;">
					</c:when>
					<c:otherwise>
	...
	<c:when test="${id != null}">
		<form id="actionForm" action="/mypage" method="post">
			...
			<button type="submit" class="submit button-primary full-width-on-mobile" style="margin:18px">Join</button>
		</form>
	
	</c:when>
	
	<c:otherwise>
		<button class="submit button-primary full-width-on-mobile" style="margin:18px" onclick="needLogin()">Join</button>
	</c:otherwise>
