			   			...
			   			<ul class="slides">
				   			...
				   			<li>
				   				<div class="featured-post-slide">
								   	...
								   	<div class="post-content">
								   		<h1 class="slide-title"><a href="#" title="">Join Groups that Fit Your Interests</a></h1> 
								   	</div> 				   					  
				   			...
				   			<li>
				   				<div class="featured-post-slide">
								   	...
								   	<div class="post-content">
								   		<h1 class="slide-title"><a href="#" title="">Find the Work-Life Balance</a></h1>
						   			</div>		   				   					  
				   			...
				   			<li>
				   				<div class="featured-post-slide">
								   	...
								   	<div class="post-content">
								   		<h1 class="slide-title"><a href="#" title="">Meet and Communicate with Neighborhood</a></h1>
						   			</div>
